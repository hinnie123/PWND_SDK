...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
	...
	struct FVector                                     EffectorLocation;                                         // 0x0088(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     JointTargetLocation;                                      // 0x0094(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FName                                       EffectorSpaceBoneName;                                    // 0x00A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bTakeRotationFromEffectorSpace : 1;                       // 0x00A8(0x0001) (Edit)
	unsigned char                                      bMaintainEffectorRelRot : 1;                              // 0x00A8(0x0001) (Edit)
	unsigned char                                      bAllowStretching : 1;                                     // 0x00A8(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00A9(0x0003) MISSED OFFSET
	struct FVector2D                                   StretchLimits;                                            // 0x00AC(0x0008) (Deprecated, IsPlainOldData)
	float                                              StartStretchRatio;                                        // 0x00B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxStretchScale;                                          // 0x00B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     EffectorLocationSpace;                                    // 0x00BC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     JointTargetLocationSpace;                                 // 0x00BD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x00BE(0x0002) MISSED OFFSET
	struct FName                                       JointTargetSpaceBoneName;                                 // 0x00C0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAllowTwist;                                              // 0x00C8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00C9(0x0003) MISSED OFFSET
	struct FAxis                                       TwistAxis;                                                // 0x00CC(0x0010) (Edit)
	bool                                               bNoTwist;                                                 // 0x00DC(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
struct FAnimNode_Fabrik : public FAnimNode_SkeletalControlBase
{
	...
	struct FBoneReference                              EffectorTransformBone;                                    // 0x00A8(0x0018) (Edit)
	TEnumAsByte<EBoneRotationSource>                   EffectorRotationSource;                                   // 0x00C0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x00C1(0x0007) MISSED OFFSET
	struct FBoneReference                              TipBone;                                                  // 0x00C8(0x0018) (Edit)
	struct FBoneReference                              RootBone;                                                 // 0x00E0(0x0018) (Edit)
	float                                              Precision;                                                // 0x00F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxIterations;                                            // 0x00FC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableDebugDraw;                                         // 0x0100(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	...
	struct FTargetReference                            LookAtTarget;                                             // 0x00B0(0x0060) (Edit)
