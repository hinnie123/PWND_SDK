...
// Function AssetRegistry.AssetRegistryHelpers.ToStringReference
...
struct FStringAssetReference UAssetRegistryHelpers::STATIC_ToStringReference(const struct FAssetData& InAssetData)
{
	static auto fn = UObject::FindObject<UFunction>("Function AssetRegistry.AssetRegistryHelpers.ToStringReference");

	UAssetRegistryHelpers_ToStringReference_Params params;
