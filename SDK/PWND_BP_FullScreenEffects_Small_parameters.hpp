...
struct UBP_FullScreenEffects_Small_C_Get_Animation_Duration_Params
{
	float                                              Duration;                                                 // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
};

// Function BP_FullScreenEffects_Small.BP_FullScreenEffects_Small_C.Start_Hiding_Me
struct UBP_FullScreenEffects_Small_C_Start_Hiding_Me_Params
{
};

// Function BP_FullScreenEffects_Small.BP_FullScreenEffects_Small_C.Set_Text_Brush
struct UBP_FullScreenEffects_Small_C_Set_Text_Brush_Params
{
...
struct UBP_FullScreenEffects_Small_C_Get_Text_Brush_1_Params
{
	struct FSlateBrush                                 ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};

// Function BP_FullScreenEffects_Small.BP_FullScreenEffects_Small_C.Tick
struct UBP_FullScreenEffects_Small_C_Tick_Params
{
...
struct UBP_FullScreenEffects_Small_C_ExecuteUbergraph_BP_FullScreenEffects_Small_Params
{
