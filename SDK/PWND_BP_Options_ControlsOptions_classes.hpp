...
// WidgetBlueprintGeneratedClass BP_Options_ControlsOptions.BP_Options_ControlsOptions_C
// 0x0020 (0x0250 - 0x0230)
class UBP_Options_ControlsOptions_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_Options_ControlsOptions.BP_Options_ControlsOptions_C");
		return ptr;
	}
	...
	void Change_Value(int Option_button_index, int Value, bool Custom_Value);
	void Set_Option_Value_to_Custom(int Index);
	void SetAttentionOnTopElementOfPage();
	void ExecuteUbergraph_BP_Options_ControlsOptions(int EntryPoint);
};
