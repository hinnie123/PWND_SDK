...
// WidgetBlueprintGeneratedClass BP_Options_GameplayOptions.BP_Options_GameplayOptions_C
// 0x0010 (0x0240 - 0x0230)
class UBP_Options_GameplayOptions_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_Options_GameplayOptions.BP_Options_GameplayOptions_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Options_GameplayOptions(int EntryPoint);
};
