...
// WidgetBlueprintGeneratedClass BP_Options_SoundOptions.BP_Options_SoundOptions_C
// 0x0020 (0x0250 - 0x0230)
class UBP_Options_SoundOptions_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_Options_SoundOptions.BP_Options_SoundOptions_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Options_SoundOptions(int EntryPoint);
};
