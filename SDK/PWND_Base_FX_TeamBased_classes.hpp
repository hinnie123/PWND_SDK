...
// BlueprintGeneratedClass Base_FX_TeamBased.Base_FX_TeamBased_C
// 0x003A (0x03CA - 0x0390)
class ABase_FX_TeamBased_C : public ABase_FX_C
{
public:
	...
	bool                                               bLoopingEffect;                                           // 0x03C9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Base_FX_TeamBased.Base_FX_TeamBased_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Base_FX_TeamBased(int EntryPoint);
};
