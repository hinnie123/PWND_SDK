...
struct UButton_Cindy_Secondary_C_Construct_Params
{
};

// Function Button_Cindy_Secondary.Button_Cindy_Secondary_C.OnReceiveAttention
struct UButton_Cindy_Secondary_C_OnReceiveAttention_Params
{
...
struct UButton_Cindy_Secondary_C_OnRemoveAttention_Params
{
	bool*                                              bWasMouse;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UButton_Cindy_Secondary_C_BndEvt__Button_MainButton_K2Node_ComponentBoundEvent_89_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function Button_Cindy_Secondary.Button_Cindy_Secondary_C.ExecuteUbergraph_Button_Cindy_Secondary
struct UButton_Cindy_Secondary_C_ExecuteUbergraph_Button_Cindy_Secondary_Params
{
