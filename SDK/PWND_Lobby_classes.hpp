...
public:
	...
	unsigned char                                      UnknownData00[0x198];                                     // 0x0428(0x0198) MISSED OFFSET
...
public:
	...
	class ALobbyBeaconState*                           LobbyState;                                               // 0x03D8(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FUniqueNetIdRepl                            UniqueId;                                                 // 0x03A0(0x0018) (Net)
	struct FUniqueNetIdRepl                            PartyOwnerUniqueId;                                       // 0x03B8(0x0018) (Net)
...
public:
	...
	class UClass*                                      LobbyBeaconPlayerStateClass;                              // 0x0390(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0398(0x0008) MISSED OFFSET
	bool                                               bLobbyStarted;                                            // 0x03A0(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x03A1(0x0003) MISSED OFFSET
	float                                              WaitForPlayersTimeRemaining;                              // 0x03A4(0x0004) (Net, ZeroConstructor, Config, IsPlainOldData)
	struct FLobbyPlayerStateInfoArray                  Players;                                                  // 0x03A8(0x00C8) (Net)
