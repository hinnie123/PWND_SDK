...
public:
	...
	struct FScriptMulticastDelegate                    OnFinished;                                               // 0x03A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TEnumAsByte<EMovieScenePlayerStatus>               Status;                                                   // 0x03B0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03B1(0x0003) MISSED OFFSET
	unsigned char                                      bReversePlayback : 1;                                     // 0x03B4(0x0001)
	unsigned char                                      bPendingFirstUpdate : 1;                                  // 0x03B4(0x0001)
	unsigned char                                      UnknownData02[0xB];                                       // 0x03B5(0x000B) MISSED OFFSET
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x03D8(0x0010) MISSED OFFSET
	struct FMovieSceneSequencePlaybackSettings         PlaybackSettings;                                         // 0x03E8(0x0028)
	unsigned char                                      UnknownData04[0x3D0];                                     // 0x0410(0x03D0) MISSED OFFSET
